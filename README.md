...
- **Start, Stop, and Restart** stay on the project row — including while it’s running. After a failed start or stop, or when a web service is not responding, **View output** is the primary action so you can see what happened; Start or Stop remains in More
