...
<p align="center">
  <img src="media/gallery-01-hero.png" width="1280" alt="Runlist in VS Code with a running web app and a second repo">
</p>

<p align="center">Every local app. One sidebar.</p>

<p align="center">
  <img src="media/gallery-02-status.png" width="1280" alt="Running project cards with status and ports">
</p>

<p align="center">See what’s running. Stop it from here.</p>

<p align="center">
  <img src="media/gallery-03-features.png" width="1280" alt="Preview and service addresses for a running app">
</p>

<p align="center">Ports, preview, and a stack you can start as a group.</p>
...
| **Copy Runlist Support Diagnostics** | From the Command Palette, copies a bounded local JSON report with correlated lifecycle state transitions, ownership and lock decisions, and anonymous project references. It excludes project names, folders, commands, environment values, ports, process IDs, and process output. Enable **Runlist › Diagnostics: Trace** only when support needs redacted error details. |
