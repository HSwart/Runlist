...
- Connected agents can read saved project status through MCP; with Copilot connected, **Ask your agent** opens VS Code chat with a prefilled diagnosis request
