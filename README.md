...
- Connected agents can read saved project status through MCP; after you set up GitHub Copilot in Runlist, **Ask your agent** opens VS Code chat with a prefilled diagnosis request you can send
