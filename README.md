...
- **Ask your agent** from the project More menu when a failed start is still saved. If an agent is connected, Runlist sends a short failure summary; otherwise it copies a diagnosis request for you to paste. Nothing is sent unless you press Ask your agent.
