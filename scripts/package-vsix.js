...
const REVIEWED_PACKAGE_FILES = Object.freeze([
  ...
  'media/fonts/Inter-Medium.ttf',
  'media/fonts/Inter-Regular.ttf',
  'media/fonts/Inter-SemiBold.ttf',
  'media/fonts/JetBrainsMono-Regular.ttf',
  'media/main.js',
  ...
  'src/lifecycle/runlist-terminal.js',
  'src/lifecycle/project-status.js',
  'src/lifecycle/ready-open-offer.js',
  ...
  'src/ports/worktree-identity.js',
  'src/ports/worktree-ports.js',
